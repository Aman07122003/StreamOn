...
const uploadVideoOnCloudinary = async (localFilePath) => {
  try {
    ...
    console.log("cloudinary videofile response:", cldnry_res);
    ...
    // If HLS URL is not available, use the regular video URL as fallback
    const videoUrl = hlsurl || cldnry_res.secure_url;
    ...
    return { 
      ...cldnry_res, 
      hlsurl: videoUrl,
      url: cldnry_res.secure_url // Keep original URL as well
    };
  } catch (error) {
